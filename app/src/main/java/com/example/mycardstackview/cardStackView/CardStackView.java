...
public class CardStackView extends ViewGroup implements ScrollDelegate {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setAnimationType(array.getInt(R.styleable.CardStackView_stackAnimationType, ALL_DOWN));
...
//            y = clamp(y, mShowHeight, mTotalLength);
    ...
    public static abstract class ViewHolder {
        ...
        public abstract void onAnimationStateChange(int state, boolean willBeSelect, int position);
    }
