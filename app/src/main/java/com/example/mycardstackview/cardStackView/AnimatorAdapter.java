    ...
    private void onItemExpand(final CardStackView.ViewHolder viewHolder, final int position) {
        ...
        mSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (preSelectViewHolder != null) {
                    preSelectViewHolder.onAnimationStateChange(CardStackView.ANIMATION_STATE_END, false, position);
                }
                viewHolder.onAnimationStateChange(CardStackView.ANIMATION_STATE_END, true, position);
            }
